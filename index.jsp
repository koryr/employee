...
//	String xmlcnf = context.getInitParameter("xml");
	String xmlcnf = "employee.xml";
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/logos/logo_heade.png" alt="Employee System" style="margin: 20px 10px 0 10px; width: 107px;" class="logo-default"/>
			</a>
...
<div class="page-footer">
	<div class="page-footer-inner">
   		...
   		2018 &copy; Korir. <a href="http://korir.me.ke">Haron Korir.</a>
	</div>
